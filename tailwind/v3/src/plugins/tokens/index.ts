...
export const tokens = plugin(({ addBase, theme }) =>
  addBase({
    ...
    ":root": {
      ...
      "--contents-primary": theme("colors.gray.900"),
      "--contents-secondary": theme("colors.gray.700"),
      "--contents-tertiary": theme("colors.gray.600"),
      "--contents-quaternary": theme("colors.gray.500"),
      "--contents-unselected": theme("colors.gray.400"),
      "--contents-unable": theme("colors.gray.300"),
      "--contents-accent": theme("colors.blue.500"),
      "--contents-positive": theme("colors.green.500"),
      "--contents-negative": theme("colors.red.500"),
      "--contents-warning": theme("colors.yellow.500"),
    },
    ...
    "@media (prefers-color-scheme: dark)": {
      ":root": {
        ...
        "--contents-primary": theme("colors.gray.100"),
        "--contents-secondary": theme("colors.gray.300"),
        "--contents-tertiary": theme("colors.gray.400"),
        "--contents-quaternary": theme("colors.gray.500"),
        "--contents-unselected": theme("colors.gray.600"),
        "--contents-unable": theme("colors.gray.700"),
        "--contents-accent": theme("colors.blue.500"),
        "--contents-positive": theme("colors.green.500"),
        "--contents-negative": theme("colors.red.500"),
        "--contents-warning": theme("colors.yellow.500"),
